...
const TEAM_COLOURS: Record<string, Colours> = {
  ...
  // ============================================================
  // API-Football typically uses "W" suffix or full "Women" for women's teams.
  // Colours match their parent clubs.
  'barcelona femeni': { primary: '#A50044', secondary: '#004D98' },
  'barcelona w': { primary: '#A50044', secondary: '#004D98' },
  'fc barcelona feminí': { primary: '#A50044', secondary: '#004D98' },
  'fc barcelona femeni': { primary: '#A50044', secondary: '#004D98' },
  'lyon w': { primary: '#FFFFFF', secondary: '#D2122E' },
  'olympique lyonnais w': { primary: '#FFFFFF', secondary: '#D2122E' },
  'olympique lyonnais feminines': { primary: '#FFFFFF', secondary: '#D2122E' },
  'chelsea w': { primary: '#034694', secondary: '#FFFFFF' },
  'chelsea women': { primary: '#034694', secondary: '#FFFFFF' },
  'arsenal w': { primary: '#EF0107', secondary: '#FFFFFF' },
  'arsenal women': { primary: '#EF0107', secondary: '#FFFFFF' },
  'manchester city w': { primary: '#6CABDD', secondary: '#FFFFFF' },
  'manchester city women': { primary: '#6CABDD', secondary: '#FFFFFF' },
  'bayern munich w': { primary: '#DC052D', secondary: '#FFFFFF' },
  'bayern munich women': { primary: '#DC052D', secondary: '#FFFFFF' },
  'fc bayern münchen w': { primary: '#DC052D', secondary: '#FFFFFF' },
  'fc bayern münchen feminines': { primary: '#DC052D', secondary: '#FFFFFF' },
  'vfl wolfsburg w': { primary: '#65B32E', secondary: '#FFFFFF' },
  'wolfsburg w': { primary: '#65B32E', secondary: '#FFFFFF' },
  'wolfsburg women': { primary: '#65B32E', secondary: '#FFFFFF' },
  'real madrid w': { primary: '#FFFFFF', secondary: '#FEBE10' },
  'real madrid femenino': { primary: '#FFFFFF', secondary: '#FEBE10' },
  'real madrid women': { primary: '#FFFFFF', secondary: '#FEBE10' },
  'paris saint-germain w': { primary: '#004170', secondary: '#DA291C' },
  'paris saint germain w': { primary: '#004170', secondary: '#DA291C' },
  'psg w': { primary: '#004170', secondary: '#DA291C' },
  'psg women': { primary: '#004170', secondary: '#DA291C' },
  'juventus w': { primary: '#000000', secondary: '#FFFFFF' },
  'juventus women': { primary: '#000000', secondary: '#FFFFFF' },
  'as roma w': { primary: '#8E1F2F', secondary: '#F5A623' },
  'roma w': { primary: '#8E1F2F', secondary: '#F5A623' },
  'roma women': { primary: '#8E1F2F', secondary: '#F5A623' },
  'ac milan w': { primary: '#FB090B', secondary: '#000000' },
  'ac milan women': { primary: '#FB090B', secondary: '#000000' },
  'atletico madrid w': { primary: '#CB3524', secondary: '#FFFFFF' },
  'atletico madrid women': { primary: '#CB3524', secondary: '#FFFFFF' },
  'atlético madrid w': { primary: '#CB3524', secondary: '#FFFFFF' },
  'benfica w': { primary: '#E20714', secondary: '#FFFFFF' },
  'sl benfica w': { primary: '#E20714', secondary: '#FFFFFF' },
  'benfica women': { primary: '#E20714', secondary: '#FFFFFF' },
  'ajax w': { primary: '#CC0000', secondary: '#FFFFFF' },
  'ajax women': { primary: '#CC0000', secondary: '#FFFFFF' },
  'twente w': { primary: '#CC0000', secondary: '#FFFFFF' },
  'fc twente w': { primary: '#CC0000', secondary: '#FFFFFF' },
  'fc twente women': { primary: '#CC0000', secondary: '#FFFFFF' },
  'hammarby w': { primary: '#006400', secondary: '#FFFFFF' },
  'hammarby women': { primary: '#006400', secondary: '#FFFFFF' },
  'häcken w': { primary: '#FFCD00', secondary: '#000000' },
  'hacken w': { primary: '#FFCD00', secondary: '#000000' },
  'bk häcken w': { primary: '#FFCD00', secondary: '#000000' },
  'rosengard': { primary: '#003DA5', secondary: '#FFFFFF' },
  'fc rosengard': { primary: '#003DA5', secondary: '#FFFFFF' },
  'rosengård': { primary: '#003DA5', secondary: '#FFFFFF' },
  'slavia prague w': { primary: '#CC0000', secondary: '#FFFFFF' },
  'slavia praha w': { primary: '#CC0000', secondary: '#FFFFFF' },
  'celtic w': { primary: '#00843D', secondary: '#FFFFFF' },
  'celtic women': { primary: '#00843D', secondary: '#FFFFFF' },
  'rangers w': { primary: '#0000FF', secondary: '#FFFFFF' },
  'rangers women': { primary: '#0000FF', secondary: '#FFFFFF' },
  'galatasaray w': { primary: '#CC0000', secondary: '#FFCD00' },
  'galatasaray women': { primary: '#CC0000', secondary: '#FFCD00' },
  'st. pölten w': { primary: '#003DA5', secondary: '#FFCD00' },
  'skn st. pölten w': { primary: '#003DA5', secondary: '#FFCD00' },
  'valerenga w': { primary: '#003DA5', secondary: '#CC0000' },
  'vålerenga w': { primary: '#003DA5', secondary: '#CC0000' },
  'anderlecht w': { primary: '#6B4EAE', secondary: '#FFFFFF' },
  'anderlecht women': { primary: '#6B4EAE', secondary: '#FFFFFF' },
  'servette w': { primary: '#8B0000', secondary: '#FFFFFF' },
  'servette women': { primary: '#8B0000', secondary: '#FFFFFF' },
  'roma cf': { primary: '#8E1F2F', secondary: '#F5A623' },
  'fiorentina w': { primary: '#482E92', secondary: '#FFFFFF' },
  'fiorentina women': { primary: '#482E92', secondary: '#FFFFFF' },
};
